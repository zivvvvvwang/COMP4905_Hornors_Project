...
class NoteDetailVC: UIViewController {
    ...
    lazy var deleteIcon: UIButton = {
        let btn = UIButton(frame: CGRect(x: 80, y: 50, width: 0, height: 30))
    ...
    @objc func save() {
        ...
        CacheManager.shared.modifyNote(Note(id: note.id, name: title, content: content))
    ...
    @objc func mDelete() {
        CacheManager.shared.deleteNote(note)
